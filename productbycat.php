            ...
            <div class="module_pro_all">
                ...
                <div class="pro_all_gird">
                    <div class="girds_all list_all_other_page ">
                        <?php
                        foreach($productbycathome as $key => $product){ 
                        ?>
                        <div class="grids">
                            <div class="grids_in">
                                <div class="content">
                                    ...
                                    <div class="add_card">
                                        ...
                                        <input type="button" name="add_to_cart" id="<?php echo $product['productId'] ?>" class="btn-styling-cart add_to_cart" value="Đặt hàng" /> 
